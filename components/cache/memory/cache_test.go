...
import (
	...
	"github.com/apus-run/gala/components/cache/memory"
)
...
func Test_Cache_Memory_Del(t *testing.T) {
...
func Test_Cache_Memory_Set_Override(t *testing.T) {
	t.Parallel()
	var (
		testStore        = memory.New()
		key       string = "john"
...
func Test_Cache_Memory_Set_Expiration(t *testing.T) {
	t.Parallel()
	var (
...
func Test_Cache_Memory_Set_Long_Expiration_with_Keys(t *testing.T) {
	t.Parallel()
	var (
		testStore     = memory.New()
		key           = "john"
...
func Test_Cache_Memory_Get_NotExist(t *testing.T) {
	t.Parallel()
	var (
		testStore = memory.New()
		ctx       = context.Background()
...
func TestCache_Deletes(t *testing.T) {
	...
	testCases := []struct {
		name   string
		before func(ctx context.Context, t *testing.T, cache cache.Cache)
...
func Test_Cache_Memory_Conn(t *testing.T) {
	t.Parallel()
	testStore := memory.New()
