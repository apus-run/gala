...
import (
	...
	"github.com/apus-run/gala/components/idgen"
)
...
func NewIDGenerator(client *redis.Client, srvIDs []int64) (idgen.IDGenerator, error) {
	if len(srvIDs) == 0 {
...
func (i *generator) GenID(ctx context.Context) (int64, error) {
	...
	if err != nil {
		return 0, errors.New("failed to generate id: " + err.Error())
	}
	return ids[0], nil
}
