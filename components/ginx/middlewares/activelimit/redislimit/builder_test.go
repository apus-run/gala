...
import (
	...
	redismocks "github.com/apus-run/gala/components/ginx/internal/mocks"
)
...
func TestRedisActiveLimit_Build(t *testing.T) {
	testCases := []struct {
		...
		maxCount         int64
		key              string
		mock             func(ctrl *gomock.Controller, key string) counter
		getReq           func() *http.Request
		createMiddleware func(redisClient counter) gin.HandlerFunc
