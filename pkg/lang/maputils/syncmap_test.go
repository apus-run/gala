...
func TestMap_LoadOrStore(t *testing.T) {
	...
	t.Run("store non-nil value", func(t *testing.T) {
		m, user := SyncMap[string, *User]{}, &User{Name: "Tom"}
	...
	t.Run("store nil value", func(t *testing.T) {
		m, user := SyncMap[string, *User]{}, &User{Name: "Jerry"}
...
func TestMap_Range(t *testing.T) {
	...
	t.Run("non-pointer type key", func(t *testing.T) {
		m, tom, jerry := SyncMap[string, *User]{}, &User{Name: "Tom"}, &User{Name: "Jerry"}
		var zero *User
	...
	t.Run("pointer type key", func(t *testing.T) {
		m, tom := SyncMap[*User, string]{}, &User{Name: "Tom"}
		var zero *User
		m.Store(tom, "Tom")
		m.Store(zero, "nil")
...
func ExampleSyncMap_LoadOrStoreFunc() {
	var m = SyncMap[string, *User]{}
