// Package conv helps users convert any type to the convertible type.
package conv
...
// ToR converts any type to result.R.
//
// 🚀 EXAMPLE:
//
//	ToR[bool]("true") ⏩ result.OK(true)
//	ToR[int64]("1.0") ⏩ result.OK[int64](1)
//	ToR[string](true) ⏩ result.OK("true")
//	p := gptr.Of(gptr.Of(gptr.Of('a')))
//	ToR[int64](p)     ⏩ result.OK[int64](97)
//	ToR[int64]("a")   ⏩ result.Err[int64]("strconv.ParseInt: parsing \"a\": invalid syntax")
//
// ⚠️ WARNING: byte is an alias for uint8, rune is an alias for int32.
//
//	ToR[string]('a')  ⏩ result.OK("97")
//	ToR[string]('中') ⏩ result.OK("20013")
func ToR[T convertible, V any](v V) result.R[T] {
	return result.Of(ToE[T](v))
}
...
func toNumber[T number](a any) (T, error) {
	...
	default:
		...
		switch rt.Kind() {
		case reflect.Bool:
			return cond.If[T](reflect.ValueOf(a).Bool(), 1, 0), nil
		case reflect.Int, reflect.Int8, reflect.Int16, reflect.Int32, reflect.Int64:
