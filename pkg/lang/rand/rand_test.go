...
import (
	...
	rand "github.com/apus-run/gala/pkg/lang/rand"
)

func TestRandomString(t *testing.T) {
	testRandomString(t, rand.RandomString)
}

func TestRandomStringWithAlphabet(t *testing.T) {
	testRandomStringWithAlphabet(t, rand.RandomStringWithAlphabet)
}

func TestPseudorandomString(t *testing.T) {
	testRandomString(t, rand.PseudorandomString)
}

func TestPseudorandomStringWithAlphabet(t *testing.T) {
	testRandomStringWithAlphabet(t, rand.PseudorandomStringWithAlphabet)
}
